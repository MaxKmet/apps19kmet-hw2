...
public class ImmutableArrayList implements ImmutableList {
    ...
    private ImmutableArrayList getCopy() {
        ImmutableArrayList newArrayList = new ImmutableArrayList(capacity);
        System.arraycopy(array, 0, newArrayList.array, 0, size);
        newArrayList.size = size;
        return newArrayList;
    }

    private ImmutableArrayList getExtendedCopy() {
        ImmutableArrayList extendedArrayList = new ImmutableArrayList(capacity * 2 + 1);
        System.arraycopy(array, 0, extendedArrayList.array, 0, size);
        System.arraycopy(array, 0, extendedArrayList.array, 0, size);
        extendedArrayList.size = size;
